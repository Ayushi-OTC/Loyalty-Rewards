class Rewards::Assigner
  ...
  def free_coffee_conditions
    errors.add(:base, 'You cannot claim free coffee') unless Rewards::Validations::FreeCoffee.new(user, params).pass?
  end

  def cash_rebate_conditions
    errors.add(:base, 'You cannot claim cash rebate') unless Rewards::Validations::CashRebate.new(user, params).pass?
  end

  def movie_ticket_conditions
    errors.add(:base, 'You cannot claim movie ticket') unless Rewards::Validations::MovieTicket.new(user, params).pass?
  end
end
